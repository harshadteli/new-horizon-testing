 /* === CONFIG SECTION === */
        const guideCommands = [
            ...
            { text: "💵 Help with Payment", audio: "./PAGES/VOICE/online.mp3", reply: "To select the online or offline payment method in the form then according to you way  in case of online payment pay with 📲QR code scanner available on  Online payment page through Phone-Pay or Google Pay,Once you can pay the amount then take the screenshot & upload it through form.Once you can uploaded your payment screenshot then your Registration is confirmed in case of Online payment." }
        ];
